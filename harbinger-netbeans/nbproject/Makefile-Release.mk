...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../bin/WIN32/libharbinger.a

../bin/WIN32/libharbinger.a: ${OBJECTFILES}
	${MKDIR} -p ../bin/WIN32
	${RM} ../bin/WIN32/libharbinger.a
	${AR} -rv ../bin/WIN32/libharbinger.a ${OBJECTFILES} 
	$(RANLIB) ../bin/WIN32/libharbinger.a
