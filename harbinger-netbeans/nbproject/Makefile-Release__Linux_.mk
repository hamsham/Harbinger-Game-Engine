...
${OBJECTDIR}/_ext/1360937237/geometry.o: nbproject/Makefile-${CND_CONF}.mk ../src/geometry.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.cc) -w -s -I../include -I../../hamlibs/include -I/usr/include/freetype2 -std=c++11 -W -Wall -Werror -Wextra -pedantic -mmmx -msse -msse2 -msse3 -mfpmath=sse -O3  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/geometry.o ../src/geometry.cpp
