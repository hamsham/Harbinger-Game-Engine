...
${OBJECTDIR}/_ext/1360937237/application.o: nbproject/Makefile-${CND_CONF}.mk ../src/application.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -w -DDEBUG -DHGE_BUILD_DYNAMIC -I../include -I../../hamlibs/include -I../../../../../../mingw4.8.1/mingw32/i686-w64-mingw32/include/freetype2 -std=c++11 -g -Wall -Werror -Wextra -pedantic -mmmx -msse -msse2 -msse3 -mfpmath=sse -O2 -s -shared -fPIC -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/application.o ../src/application.cpp
...
${OBJECTDIR}/_ext/1360937237/renderer.o: nbproject/Makefile-${CND_CONF}.mk ../src/renderer.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.cc) -w -DDEBUG -DHGE_BUILD_DYNAMIC -I../include -I../../hamlibs/include -I../../../../../../mingw4.8.1/mingw32/i686-w64-mingw32/include/freetype2 -std=c++11 -g -Wall -Werror -Wextra -pedantic -mmmx -msse -msse2 -msse3 -mfpmath=sse -O2 -s -shared -fPIC -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/renderer.o ../src/renderer.cpp
